...
class TestEditResume:
    ...
    def test_resume_sort_order(self, client):
        ...
        r1_id = create_resume_for_user(user_id, title="Older Resume", created_at=old_time)
        
        # Create newer resume
        new_time = datetime.utcnow()
        r2_id = create_resume_for_user(user_id, title="Newer Resume", created_at=new_time)
